...
return [
    ...
    */
    ...
    'queues' => [
        'notifications' => env('RABBITMQ_QUEUE', 'notifications'),
    ],
    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            ...
            'queue_arguments' => [
                'x-max-priority' => (int) env('RABBITMQ_MAX_PRIORITY', 10),
            ],
            ...
            'exchange_auto_delete' => (bool) env('RABBITMQ_EXCHANGE_AUTO_DELETE', false),
            'queue_durable' => (bool) env('RABBITMQ_QUEUE_DURABLE', true),
            'queue_auto_delete' => (bool) env('RABBITMQ_QUEUE_AUTO_DELETE', false),
            'queue_bindings' => env('RABBITMQ_QUEUE_BINDINGS', []),
            'queue_force_declare' => (bool) env('RABBITMQ_QUEUE_FORCE_DECLARE', true),
        ],
